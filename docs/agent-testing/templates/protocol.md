...
- 设计或执行性能压测：读 `guides/performance/README.md`、`guides/performance/types.md`、`guides/performance/online.md` 和 `guides/performance/runner.md`。
...
- 性能压测：见 `docs/agent-testing/guides/performance/README.md`、`docs/agent-testing/guides/performance/types.md`、`docs/agent-testing/guides/performance/online.md`、`docs/agent-testing/guides/performance/runner.md` 和 `docs/agent-testing/guides/performance/subagent.md`。
